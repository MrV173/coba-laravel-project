...
<img src="https://asset.kompas.com/crops/zmyPX1lqPWG55HKx6nYIfTJ6Ak8=/109x76:795x532/750x500/data/photo/2021/09/08/6138400587c9f.jpg" class="card-img-top" alt="image" height="300" width="100">
    ...
    <div class="row">
      @foreach ($posts->skip(1) as $post)
        <div class="col-md-4 mb-3">
          <div class="card ">
            <div class="position-absolute bg-dark px-3 py2 text-white"><a href="/posts?category={{  $post->category->slug }}" 
